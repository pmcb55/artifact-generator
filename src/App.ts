...
import { ArtifactGenerator } from "./generator/ArtifactGenerator.js";
import { ConfigFileGenerator } from "./generator/ConfigFileGenerator.js";
...
const _debug = debug("artifact-generator:App");
...
export interface AppArgv {
  ...
  globMatchTotal?: number;
  // Populated by the watcher command
...
export class App {
  argv: AppArgv;
  watcherList: VocabWatcher[];

  constructor(argv: AppArgv) {
